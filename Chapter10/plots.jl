...
# ╔═╡ aa3297ae-c0ce-11ec-39d0-a7d7e7464f49
begin
	using Plots
	import Plots: mm
	default(dpi=500)
...
# ╔═╡ 70507635-da94-44a6-877e-b7219676bf1e
plt_axes = plot()

# ╔═╡ bd430557-ee6d-488b-b4e3-896edf60db7b
plot!(plt_axes,
...
# ╔═╡ 7e4987a4-90b9-49de-9696-a53e3718d30c
axis_annotations = [
...
# ╔═╡ 65acbe26-c80e-48b8-926c-f63b0095f826
plot!(plt_axes,
...
# ╔═╡ 5bf988c0-c9c8-4cbe-bc0b-88015502da70
x_values = 0:0.25:1

# ╔═╡ a8be2a63-5892-4fd7-856e-2743742e9562
...
# ╔═╡ 585b4107-f6cb-4a59-955b-caf800732502
subplot_annotations = [
...
# ╔═╡ 8ecf40a6-b1e3-4c6a-a43c-35e44b10758c
plot!(plt_subplot,
...
# ╔═╡ 712ceece-5818-4e7b-ab57-131c9fba7c5f
subplot_a = plot(title = "Subplot title")

# ╔═╡ 3b0d736e-7a41-45a8-ae4c-804a544db322
subplot_b = plot(0:0.01:1, x -> x^2,
	title = "Subplot title",
	legend_position = :none)

# ╔═╡ f9ed07df-9d78-4a9d-9a72-6344d74cfc41
...
# ╔═╡ 7422588b-a73c-4759-a5a7-c6a2803cacbb
lens!(plt, [0.0, 0.2], [0.0, 0.1],
	background_color_inside = :gray95,
	inset_subplots = (2, 
		bbox(0.25, 0.25, 0.35, 0.2)))

# ╔═╡ d9b5b190-bd5d-43f4-a878-ff94d9a7e059
plot_annotations = [
	(0.15, 0.9, ("bounding box", :bottom, 10)),
	(0.5, 0.85, ("inset subplot", :left, 10))]

# ╔═╡ feac9399-5b1b-44ec-9a0c-f9d79c123e80
plot!(plt[2],
