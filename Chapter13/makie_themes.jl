...
# ╔═╡ a3c271d4-f734-11ec-005b-01177365dcde
begin
	using CairoMakie
	import ColorSchemes
end

# ╔═╡ d45d5638-bbb0-4984-974c-d700779ba739
journal_theme = Theme(
    resolution = (600, 400),
	fontsize = 10,
	Axis = (xlabelsize = 12, 
		ylabelsize = 12, titlesize=14),
	Legend = (titlesize = 12,),
	linewidth = 1,
	palette = (color = 
		ColorSchemes.glasbey_category10_n256.colors,),
	colormap =:linear_bgy_10_95_c74_n256)

# ╔═╡ 5035b4b4-8ac8-4e98-8fce-daf1dd7600cd
fig = with_theme(journal_theme; linewidth=2) do
	xs = collect(-5.0:0.1:5.0)
	fig, axs, plt = lines(xs, sin.(xs), 
		label="sin",
		axis=(xlabel = "x", 
			ylabel = "y", title = "Title"))
	lines!(axs, xs, cos.(xs), label="cos")
	axislegend()
	fig
end
