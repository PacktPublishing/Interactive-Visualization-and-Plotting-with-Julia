...
# ╔═╡ ba1b9ff8-7ac9-11ec-3153-55348cfe13e8
begin
	using Clustering, Distances, RDatasets, StatsPlots
	iris = dataset("datasets", "iris") 
end

# ╔═╡ f785ab22-fd04-43a0-8449-e9589986f335
distances = pairwise(CorrDist(), Matrix(iris[!, 1:4]))

# ╔═╡ eedf5164-eec9-4552-8937-0439bd49e8a0
clustering = hclust(distances, branchorder=:optimal)

# ╔═╡ 17ea1836-9561-4c05-bbaa-c92cde3c89a4
plot(clustering)

# ╔═╡ 6f95f51e-ec0e-4bc1-a97c-dfe131b0d598
variables = names(iris)[1:4]

# ╔═╡ 35356d21-4a65-4398-a8db-2b4017befe27
plot(clustering, 
	xticks=(1:4, variables[clustering.order]))

# ╔═╡ 03644fa1-d142-41b1-8343-e639e32725da
