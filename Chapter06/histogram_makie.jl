...
# ╔═╡ 2cbd62fc-5dc5-11ec-0030-ab04c142b21b
begin
	using AlgebraOfGraphics, CairoMakie
	set_aog_theme!()
end

# ╔═╡ e858644d-b43b-4e71-9668-f75d640ea39c
using RDatasets

# ╔═╡ d49810f0-caf6-455b-8ce7-9e1951e210f5
iris = dataset("datasets", "iris")

# ╔═╡ 408fdb0e-95e7-4bb7-9b52-acf7c03b4af6
md"""
*Makie*
"""

# ╔═╡ f132900a-ecb8-4f00-84c5-f95a4af7359e
hist(iris.PetalLength)

# ╔═╡ fe05afd3-045c-4ff9-95c2-60672fba34f1
md"""
*AlgebraOfGraphics*
"""

# ╔═╡ f0eaee24-6efa-4697-bd69-b8ab468de53d
data(iris) * mapping(:PetalLength) * visual(Hist) |> draw

# ╔═╡ cd03fd96-b526-4832-a227-b241c969274f
data(iris) * mapping(:PetalLength) * histogram() |> draw
