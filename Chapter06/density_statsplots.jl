...
# ╔═╡ 75e7e3aa-70a5-463c-accc-1928fea8917f
begin
	using RDatasets
	iris = dataset("datasets", "iris")
end

# ╔═╡ b5a48a96-9784-40c2-b882-800ca3a2e3d6
begin
	using StatsPlots
	plotly()
end

# ╔═╡ 1a4da6db-f5e9-4a08-be35-d0d0cc97e924
begin
	using PlutoUI
	@bind bandwidth Slider(0.1:0.1:10, show_value=true)
end

# ╔═╡ ccd3922f-b010-4453-a4cb-c90e53b7fc94
@df iris density(:PetalLength)

# ╔═╡ d4c03fe0-df1d-4136-9e81-4284dfb06a62
@df iris density(:PetalLength, trim=true)

# ╔═╡ 5642fb41-7a31-4296-bb35-ac6de4d38cfa
@df iris density(:PetalLength, 
	bandwidth=bandwidth,
