...
# ╔═╡ 25e33a7c-568d-11ec-3a71-01de4d22ad7c
using RDatasets

# ╔═╡ e10c5001-82e5-49cb-82f3-05ca99faf49a
using StatsPlots

# ╔═╡ 5f71693f-6824-484d-a74e-6e7db0eac059
using PlutoUI

# ╔═╡ 27fc1693-8e56-41dc-9d6f-8f657f57978f
 iris = dataset("datasets", "iris")

# ╔═╡ 1338bf03-2cc4-4d23-b30f-a5ae504e048a
plotly()

# ╔═╡ ec94e9d5-7b4d-430b-b185-cbce284595e2
@df iris scatter(:PetalLength, :PetalWidth)

# ╔═╡ 00064250-6be1-437b-ba3c-e7b42e90d176
@df iris scatter(pi .* :PetalLength .* :PetalWidth)

# ╔═╡ 2ba1ac1f-a447-4439-9dc4-d8a89e05c540
@df iris scatter(cols(3:4))

# ╔═╡ 3a98d05f-d8d4-455a-8579-eacb6b1aad87
@bind column_name Select(Symbol.(names(iris)[1:4]))

# ╔═╡ 2f39f776-e4f2-4074-967c-7d0f10f76c35
@df iris scatter(
	cols(column_name), 
	ylabel=column_name, 
	xlabel="Row number",
