...
# ╔═╡ 4b2b996e-6707-11ec-09e0-dd26f63f5baa
begin
...
# ╔═╡ 623d48a1-6c2c-4634-8c95-fdaed532fadd
@df iris plot(
	scatter(:PetalLength, :PetalWidth, 
		alpha=0.5,
		legend=false, title="Scatter plot"),
	histogram2d(:PetalLength, :PetalWidth, 
		bins=(12, 6),
		color=:grays, title="Bi-dimensional histogram"),
	plot(KernelDensity.kde((:PetalLength, :PetalWidth)), 
		title="Bi-dimensional density plot"),
