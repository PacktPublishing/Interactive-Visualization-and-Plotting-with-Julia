...
# ╔═╡ 561a36d2-5e94-11ec-1fc9-dd8d1ce6d2b8
begin
	using RDatasets
	iris = dataset("datasets", "iris")
end

# ╔═╡ 04f3aec9-fc10-472d-b9a4-f4b7e0d600a1
begin 
	using AlgebraOfGraphics, CairoMakie 
	set_aog_theme!() 
end 

# ╔═╡ fa67619f-cb69-4f8f-a21a-05f39a9dddb5
CairoMakie.density(iris.PetalLength)

# ╔═╡ e035aadd-bce2-44fe-a6e8-2ec160ca89a9
data(iris) * mapping(:PetalLength) * visual(Density) |> draw 

# ╔═╡ ca21adcb-5517-41ed-840f-8b2db7579eb7
data(iris) * mapping(:PetalLength) *
