...
# ╔═╡ 5ec77407-1932-4219-8588-a3b0e6970750
begin
	using RDatasets
	iris = dataset("datasets", "iris")
end

# ╔═╡ 56fea7d4-12b2-4ffd-830f-b4420870d920
begin
	using StatsPlots
	plotly()
end

# ╔═╡ 6bbc0733-62c8-43ec-97ae-7429e03c979f
@df iris violin(:PetalLength)

# ╔═╡ 6e54c197-9134-4399-9ff7-d2cc9e207e6e
@df iris violin(:PetalLength,
	trim=false,
	side=:right,
	show_mean=true, 
...
# ╔═╡ c78ec2cd-08fe-4468-a99b-ccf92373f7b3
begin
	plt = @df iris violin([1], :PetalLength, 
		fillalpha=0.4,
		linewidth=0,
		color=:green,
		legend=false)
	@df iris boxplot!(plt, [1], :PetalLength, 
		notch=true,
		bar_width=0.1,
		whisker_width=0,
		color=:green)
