...
# ╔═╡ e9f86504-793d-11ec-1982-a5e057ca5d2e
begin
	using RDatasets, StatsPlots 
	iris = dataset("datasets", "iris") 
end

# ╔═╡ 1e1ab4ad-4257-43c3-8687-8f8a502ece41
@df iris marginalhist(:PetalLength, :PetalWidth, bins=(10, 20))

# ╔═╡ c9c340d1-7570-4500-a66e-aa1ec356d407
@df iris marginalkde(:PetalLength, :PetalWidth, levels=15)

# ╔═╡ 68bc8969-efa9-4325-a650-f157076e6133
@df iris marginalscatter(:PetalLength, :PetalWidth)

# ╔═╡ 99b81e49-2cbe-4beb-9d01-ee239b58b95a
@df iris corrplot([:SepalLength :SepalWidth :PetalLength :PetalWidth], fillcolor=cgrad(), guidefontsize=9, tickfontsize=6)

# ╔═╡ 3f8a92fa-1b5d-479c-87ad-f0f6687d304a
