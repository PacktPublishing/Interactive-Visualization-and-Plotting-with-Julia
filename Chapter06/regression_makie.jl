...
# ╔═╡ 090a4bda-77de-11ec-2b91-6bb637332fc8
begin
	using CairoMakie, AlgebraOfGraphics, RDatasets
	iris = dataset("datasets", "iris") 
end

# ╔═╡ d6e6c13e-d6c3-44d3-b38b-4e8d3b1921c5
data(iris) * mapping(:PetalLength, :PetalWidth) * linear() |> draw

# ╔═╡ b772364b-e2c8-42f9-965d-54cad8be2fff
data(iris) * mapping(:PetalLength, :PetalWidth) * smooth() |> draw
