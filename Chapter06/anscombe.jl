...
# ╔═╡ 5a137489-832f-4c5f-a6f3-e4f1f89910c8
using Plots, RDatasets, Statistics

# ╔═╡ da90c3a6-05b1-4c63-932f-c5cb0bfaf138
theme(:wong)

# ╔═╡ 715c6375-c549-4f16-8fa0-b0495d283cfe
default(dpi=500)

# ╔═╡ 34667417-ee4f-4c4b-9705-c1f179e4480b
data = dataset("datasets", "anscombe")

# ╔═╡ 38e7064e-ff84-11ec-2a85-87acaa307a21
plots = map(1:4) do i
	x = data[:, Symbol("X", i)] 
	y = data[:, Symbol("Y", i)]
	r = round(cor(x, y), digits=2)
	scatter(x, y, annotation=((0.1, 1.0), 
		text("r = $r", 10, :left, :top)))
end

# ╔═╡ 2eb7f682-c3dc-40b1-a070-e0630683a746
plt = plot(plots..., legend=false, 
		plot_title="Anscombe's Quartet",
		plot_titlevspan=0.1)
