...
# ╔═╡ e8a08f40-77cd-11ec-12d0-ed2746e6bc0c
begin
	using RDatasets, Gadfly
	iris = dataset("datasets", "iris") 
end

# ╔═╡ 2315d022-2a45-4105-b514-142f63f534a3
plot(iris, x=:PetalLength, y=:PetalWidth,
	layer(Stat.smooth(method=:loess), 
		Geom.line))

# ╔═╡ 829a81f5-c5ea-42ea-9783-56fa92c662a6
plot(iris, x=:PetalLength, y=:PetalWidth,
	layer(Stat.smooth(method=:loess), 
		Geom.line),
	Geom.point)

# ╔═╡ 63d9f5b7-f891-401b-a6d4-59a55c46446d
plot(iris, x=:PetalLength, y=:PetalWidth,
	layer(Stat.smooth(method=:loess, smoothing=0.2), 
		Geom.line))

# ╔═╡ 036a5e36-8514-45ad-b161-73796e03a9e8
plot(iris, x=:PetalLength, y=:PetalWidth,
	layer(Stat.smooth(method=:lm, levels=[0.99]), 
