...
# ╔═╡ 0cd67bc7-d286-4ebb-ab41-18fb2bf56a52
begin
	using RDatasets
	iris = dataset("datasets", "iris")
end

# ╔═╡ 0178b6b0-5842-11ec-1e0a-6d3d5c499bc6
begin
	using StatsPlots
	plotly()
end

# ╔═╡ 6c82cc0e-7e04-49a1-ae1c-2f78c59f561f
@df iris histogram(:PetalLength)

# ╔═╡ 220566fb-4293-4a4c-b4c5-e2e4d635dbc1
@df iris plot(
	histogram(:PetalLength, bins=:sqrt, 
		title="Square-root choice"),
	histogram(:PetalLength, bins=:sturges, 
		title="Sturges' formula"),
	histogram(:PetalLength, bins=:rice, 
		title="Rice rule"),
	histogram(:PetalLength, bins=:scott, 
		title="Scott's normal reference rule"),
	histogram(:PetalLength, bins=:fd, 
		title="Freedman–Diaconis rule"),
	titlefontsize=10,
	legend=false)

# ╔═╡ 6597ba1a-95e8-4d04-b6d8-fc7b1a669ede
@df iris plot(
	histogram(:PetalLength, bins=10, 
		title="Integer"),
	histogram(:PetalLength, 
		bins=range(
			minimum(:PetalLength), 
			maximum(:PetalLength) + 0.1, 
			length=11),
		title="Range"),
	legend=false)

# ╔═╡ 395198a5-341f-4e1e-8bdd-767685705b5f
@df iris histogram(:PetalLength, 
