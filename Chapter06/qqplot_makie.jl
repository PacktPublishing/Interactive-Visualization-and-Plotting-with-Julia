...
# ╔═╡ 15919d78-7e6a-46cf-b805-8828805ef61d
begin
	using RDatasets
	iris = dataset("datasets", "iris")
end

# ╔═╡ 9bce78f6-ea1b-4b78-b2e2-3dbd7d1b1702
begin 
	using AlgebraOfGraphics, CairoMakie 
	set_aog_theme!() 
end

# ╔═╡ 0d73da0e-7df5-4fd7-a56e-64383d78d5cc
qqnorm(iris.PetalLength)

# ╔═╡ dbdfd060-c611-49c2-8874-9d0957c14fa6
data(iris) * mapping(:PetalLength) * visual(QQNorm) |> draw
