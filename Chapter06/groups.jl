...
# ╔═╡ 7947d99c-7ae7-11ec-3604-7f115d03cc30
begin
	using RDatasets, StatsPlots
	iris = dataset("datasets", "iris") 
end

# ╔═╡ 833961c7-23b0-4e8c-b294-569ab7493aef
@df iris boxplot(:Species, :PetalLength)

# ╔═╡ 4666b5b9-cebb-44dd-9767-4c2dde4a3205
@df iris density(:PetalLength, group=:Species)

# ╔═╡ 525dc95f-1c00-49ba-b2a6-632510ccdfe7
@df iris groupedhist(:SepalLength, group=:Species)

# ╔═╡ 9c39fb06-723c-4076-bc42-8fdf97e109cb
@df iris groupedhist(:SepalLength, group=:Species,
	bar_position=:stack)

# ╔═╡ 4513ec4c-41b7-4b9a-9f90-d56b8cfbc6f6
@df iris scatter(:PetalLength, :PetalWidth,
	group=:Species)

# ╔═╡ ab871b53-290b-49a5-a3c0-7ec171929159
@df iris scatter(:PetalLength, :PetalWidth, 
	group=:Species, 
	markershape = [:x :circle :square])
