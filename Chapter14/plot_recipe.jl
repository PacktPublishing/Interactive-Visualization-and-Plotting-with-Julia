...
# ╔═╡ 28c6cdd0-038f-11ed-2122-d5bbbdcfb7c3
using RecipesBase

# ╔═╡ d9a422c9-7629-4b5d-8b31-9bbaf41ab79f
using Plots

# ╔═╡ 4b24c378-a92e-4eb0-991b-172e86429f98
@recipe function f(::Type{Val{:xrug}}, 
		plt::AbstractPlot; main=:scatter)
...
# ╔═╡ ea02e174-ff4f-4b7b-9901-658e0b2a282c
plot(exp.(0:0.1:5), 0:0.1:5, seriestype = :xrug)

# ╔═╡ a5ac44c5-59a9-46f3-b950-6d39388d3f5a
@shorthands xrug

# ╔═╡ b9532d5b-f0e7-44af-ba50-08f11bf4efca
xrug(exp.(0:0.1:5), 0:0.1:5)
