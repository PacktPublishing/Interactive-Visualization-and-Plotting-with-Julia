...
# ╔═╡ 0627a981-90a0-4a3a-85cb-e9bfc6a649fe
using RecipesBase

# ╔═╡ 1130f515-27e7-422f-8002-c59f7e9a1ca2
using Plots

# ╔═╡ d0111be9-5785-4de4-b604-77456afb2f19
md"""
## User Recipe
"""

# ╔═╡ 6dedd8f2-fb17-11ec-1457-0143f354abc9
struct Extrema 
	min_values::Vector{Float64}
	max_values::Vector{Float64}
end

# ╔═╡ 53d592d0-21e0-45e2-9b50-02da1dfc5396
@recipe function f(values::Extrema)
	xs = Float64[]
	ys = Float64[]
	for (i, (min_val, max_val)) in enumerate(
		zip(values.min_values, values.max_values))
		append!(xs, [i, i, NaN])
		append!(ys, [min_val, max_val, NaN])
	end
	xs, ys
end

# ╔═╡ 714ddab5-69d7-446a-ba1b-2926e12c7abc
...
@recipe function f(object::Blackboard)
	background_color := :black
	foreground_color := :white
	palette --> palette([:gray90, :gray30] , 6)
	framestyle --> :none, :quiet
	linewidth --> 5, :required
	legend_position --> :none, :force
	object.args
end
...
@recipe f(::Type{VectorWrapper}, wrapper::VectorWrapper) = wrapper.vec

# ╔═╡ f1b7810d-d6d0-475e-bb6f-8d8b2ae44c73
plot(VectorWrapper(rand(10)))
