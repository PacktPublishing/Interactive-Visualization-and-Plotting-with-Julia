...
# ╔═╡ d3ffff12-0431-11ed-0193-71bb2fbc6e13
using MakieCore

# ╔═╡ b9cceca4-9ac9-4d18-9a00-028e44432c5f
using GLMakie

# ╔═╡ 9447b85d-90fb-4cc6-9edd-a9ee51bfc900
md"""
## Type recipes
"""

# ╔═╡ d65fa74e-08dd-4464-af6b-8c3767bcccd2
struct Extrema  
	min_values::Vector{Float64}
	max_values::Vector{Float64}
end

# ╔═╡ 9c25569d-d1d8-4ff7-8059-021f2883c2e3
MakieCore.plottype(::Extrema) = LineSegments

# ╔═╡ 1923d388-5915-4d2f-ae12-140c1adaa44b
...
# ╔═╡ 54aed593-c51a-4cf8-b5fc-91de5d6bbe18
plot(Extrema(rand(100) .- 1, rand(100) .+ 1))

# ╔═╡ 7934f66a-f43d-4e60-85be-31c6702ad9fa
md"""
## Full recipes
"""

# ╔═╡ ab81ba14-25e0-4d57-ace6-b979b03e8d6f
begin
...
# ╔═╡ 423115c4-e5de-4b90-9b93-7e714bd6bc2a
begin
	x = Observable(rand(100))
	y = Observable(rand(100))
end

# ╔═╡ c3df408b-b079-45f6-a269-b41fa5e56eaf
begin
	fig = Figure()
	ax = Axis(fig[1, 1])
	scatter!(ax, x, y)
...
# ╔═╡ c4e194d9-023a-4b18-93a0-3100f02a8c79
x[] = rand(100)
