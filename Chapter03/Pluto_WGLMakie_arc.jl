...
# ╔═╡ e8b1ffb8-21d4-11ec-3acf-8b9509cead36
begin
	using JSServe
	Page()
end

# ╔═╡ 6de180b0-96e2-43e3-88f3-40d261e2700a
using WGLMakie, PlutoUI

# ╔═╡ bb432fa1-9768-4373-b6ed-f25e5607fd9a
points = WGLMakie.Observable(Point2[]);

# ╔═╡ 8fe29e53-f7f9-4ac9-93b9-4ee5902c6209
md"""
angle $(@bind angle PlutoUI.Slider(0:0.01:2pi, default=pi/2, show_value=true))
"""

# ╔═╡ eb4fd768-5152-42f2-b629-25b6218208ed
points[] = [Point2(cos(a), sin(a)) for a in range(0, angle, length=100)];

# ╔═╡ d151eb75-9b05-4fb8-a7e8-b78184f1c685
lines(
	points, 
	axis=(aspect=DataAspect(), limits=(-1.5, 1.5, -1.5, 1.5)),
