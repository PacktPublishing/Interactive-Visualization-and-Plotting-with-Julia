...
# ╔═╡ 08c0e90a-9047-11ec-1976-59a01f2ca932
begin 
	using Graphs, MetaGraphs
	using Plots , GraphRecipes
end

# ╔═╡ c7115532-dfbb-4a7a-a60d-ff780460839d
graph = path_graph(3)

# ╔═╡ 599202fc-ab4c-4bb1-a0a6-4cf4a0b90d3e
graphplot(graph)

# ╔═╡ 73b42010-13c1-41c5-99b3-08c399d3bc60
network = MetaGraph(graph)

# ╔═╡ 95a4cbae-7f5d-4d11-9175-f78a19bd55e2
edge_weights = weights(network)

# ╔═╡ 0f15801f-53a8-4445-8eba-a392465e2a4b
set_prop!(network, 1, 2, :weight, 0.5)

# ╔═╡ 548ea3a1-77a3-495b-ba6b-c49971e87188
collect(edge_weights)

# ╔═╡ 157084da-4c19-4112-8537-38bdc7bcfa16
edge_weights[1, 2]

# ╔═╡ 84af6332-ec3f-417c-90b4-9de2a91d38cf
set_prop!(network, :name, "Example network")

# ╔═╡ cc55dddd-844f-44c9-8d0f-c5ffa8ccb92c
set_prop!(network, 1, :name, "First node")

# ╔═╡ cf2c3741-a51b-4e50-ab62-8350ed7a90b5
set_prop!(network, 1, 2, :name, "First link")

# ╔═╡ 143889f0-1fae-4833-8852-47d1826ffa46
get_prop(network, :name)

# ╔═╡ 67e67d39-6e02-42df-8820-6aa669745555
get_prop(network, 1, :name)

# ╔═╡ 83128c45-8d0d-4dfa-b21b-d61beeeb1819
get_prop(network, 1, 2, :name)

# ╔═╡ 06df6db2-75b5-4844-a4ab-c672ca757877
props(network, 1, 2)
