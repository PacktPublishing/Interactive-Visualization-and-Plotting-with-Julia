...
begin
	figure, axis, plt = graphplot(graph,
		...
		node_size = fill(16, nv(graph)),
		edge_width = fill(2.5, ne(graph)),
		node_attr = (strokewidth = 2.5, strokecolor = :lightgray),
		nlabels = node_labels,
...
# ╔═╡ 1fe31dd6-128e-4249-84fc-2891df3d0801
...
# ╔═╡ ff6238a4-ba6f-406f-9f44-b66e09267d39
register_interaction!(axis, :nodeclick, NodeClickHandler(node_action))

# ╔═╡ 19c12f14-b59d-4b3a-b4f8-4fd4366c8431
display(figure)
