...
# ╔═╡ adcb7916-b5e4-11ec-23f6-03e8fc3f7f57
using Phylo, Plots

# ╔═╡ 6da52afa-bc47-424e-80d1-8d072ab069c4
newick = "(Leaf_A:0.1,(Leaf_B:0.2,Leaf_C:0.1)Internal:0.1)Root;"

# ╔═╡ 3e7b6bd0-a06a-44f3-857c-b35643f7482b
tree = parsenewick(newick)

# ╔═╡ beb6ad31-a9fa-4d9c-bdfc-6436f85a90d0
plot(tree, size=(500,200))

# ╔═╡ fffb752b-1150-40c9-b157-e9e5c1683803
begin
	before = plot(tree, 
		title="Tree before sorting", 
		size=(550,200))
	sort!(tree)
	after = plot(tree, 
		title="Tree after sorting", 
		size=(550,200))
	plot(before, after, 
		titlefontsize=8, titlelocation=:left)
end

# ╔═╡ 098b27b5-3fc8-4788-823c-550fede50d43
trait = map_depthfirst(
	(val, node) -> val + randn(), 
	0.0, tree)

# ╔═╡ e483f469-a1e0-4852-a3d3-0912a8a17239
plot(tree,
	treetype = :fan,
	line_z = trait,
	linewidth = 3,
...
git-tree-sha1 = "fe4370547df637e4b6dfd6446ec227a4fd780cad"
