...
# ╔═╡ 1ca756a4-61fd-4e72-b9bd-e3305f6875d1
using MIToS.MSA
...
# ╔═╡ d9061cbd-0031-445a-b35c-88050e3c8e4e
using BioMakie
...
[deps]
BioMakie = "7de43156-b762-4475-b39f-ba1e1e59ee2f"
...
git-tree-sha1 = "60183321f012000f408797b6753540cd26bf2cba"
...
[[BioMakie]]
deps = ["AbstractPlotting", "BioSequences", "BioStructures", "CUDA", "ColorSchemes", "Colors", "CommonSubexpressions", "DataFrames", "DataStructures", "DelimitedFiles", "Distances", "Distributions", "Documenter", "FastaIO", "FileIO", "GLFW", "GLMakie", "GeometryBasics", "HTTP", "Hyperscript", "JSServe", "LightGraphs", "Literate", "MIToS", "Markdown", "NamedArrays", "Observables", "OrderedCollections", "Parameters", "Phylo", "Printf", "Random", "SplitApplyCombine", "TableTraitsUtils", "TensorCast"]
git-tree-sha1 = "17ff2d1ae18cecc0162472a1b3396ffa1dcf58c9"
...
[[BioStructures]]
deps = ["BioAlignments", "BioCore", "BioGenerics", "BioSequences", "BioSymbols", "CodecZlib", "DataFrames", "Format", "LightGraphs", "LinearAlgebra", "MMTF", "MetaGraphs", "RecipesBase", "Statistics"]
git-tree-sha1 = "a0001d6322908756d5d1aec3fa55b617cb58fc64"
...
git-tree-sha1 = "d5e296dea44f9cfb8cc83681aa3db367e0cbfd4f"
...
git-tree-sha1 = "4ef559a00a8bd1e0804efab4472f03a01ec8852b"
...
[[MMTF]]
deps = ["CodecZlib", "MsgPack"]
git-tree-sha1 = "47dbc704892684af729551e2680091e2ec224b3d"
...
[[TensorCast]]
deps = ["ChainRulesCore", "LazyStack", "LinearAlgebra", "MacroTools", "Random", "StaticArrays", "TransmuteDims"]
git-tree-sha1 = "018f743e33cde3dae47f3c5fa4f0f5f4cf544f56"
...
[[TransmuteDims]]
deps = ["Adapt", "ChainRulesCore", "GPUArrays", "LinearAlgebra", "Requires", "Strided"]
git-tree-sha1 = "5f29bd26c02cb018fe003de0b4c4c170b2a0a66f"
