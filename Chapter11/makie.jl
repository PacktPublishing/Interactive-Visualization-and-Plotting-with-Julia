...
# ╔═╡ 873e69ba-0b26-11ed-31ea-0760062d376d
using CairoMakie

# ╔═╡ 4d6a5776-85ea-49b0-9536-d67abef536d7
begin
	xs = 0:0.1:2pi
	fig = Figure()
	axis_a = Axis(fig[1,1])
...
# ╔═╡ e6346fb4-679e-4b07-b83e-9d0459d97f87
begin
	layout_b = GridLayout()
	fig[1,2] = layout_b
	axis_b_1 = Axis(layout_b[1,1])
	axis_b_2 = Axis(layout_b[2,1])
	scatter!(axis_b_1, xs, sin, color=sin.(xs))
	scatter!(axis_b_2, xs, cos, color=cos.(xs))
	fig
end

# ╔═╡ 3486dfcf-134f-48a0-93ba-61b9162f0198
begin
	Colorbar(layout_b[1:2, 2], colorrange=(-1,1))
	fig
end

# ╔═╡ f532a62b-47c1-422b-9098-30d33f203ed1
begin
	colgap!(fig.layout, 40)
	fig
end

# ╔═╡ b1bee549-d798-4358-8cfd-15eea262d4c1
begin
	Label(fig[1, 1, TopLeft()], "A", 
		textsize = 24, padding = (0, 35, 10, 0))
