...
# ╔═╡ 385e4c4d-5631-4084-a55c-3e11a47b3ce4
using GLMakie

# ╔═╡ 254eba4b-ea5e-431f-9f59-fc8ab6cdae4b
using PlutoUI

# ╔═╡ 0e02fd2e-4e47-4ea3-99a7-1ff11d8b493a
angle = Observable(0.0)

# ╔═╡ 7ebe037d-e6c1-4714-9aeb-4a188c49ec8b
point = @lift Point2(cos($angle), sin($angle))

# ╔═╡ 5986aacd-d889-4efb-a97b-da060fddc411
plt = scatter(point, 
	axis=(
		aspect=DataAspect(), 
		limits=(-1.5, 1.5, -1.5, 1.5)))

# ╔═╡ 677d6d8f-5f69-47b5-801b-0e1ed29fb776
anim = record(plt, "rotating.gif", 0:0.05:2pi) do value
    angle[] = value
end

# ╔═╡ 7bfbfc65-045d-466c-b7cb-508c239662ab
LocalResource(anim)
