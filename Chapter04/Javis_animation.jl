...
# ╔═╡ 3d34adac-4708-4f1b-869c-171c61fd31ca
using Javis

# ╔═╡ 20f9bc3c-d170-4d3f-8473-927296b3aa3a
function ground(args...)
    background("white")
    sethue("blue")
end

# ╔═╡ 7ac93643-8b9c-4523-a302-ab8fb234ffbb
function create_point(args...)
	circle(O, 10, :fill)
end

# ╔═╡ f87c1b04-e23a-4ac2-be37-920f3b58c0b4
begin
	video = Video(500, 500)
	Background(1:50, ground)
	point = Object(create_point, Point(100, 0))
	act!(point, 
		Action(anim_rotate_around(2π, 0.0, O)))
end

# ╔═╡ 04c6b119-553d-4772-9947-bc363ba2d9de
render(video; pathname="javis_animation.gif")
...
git-tree-sha1 = "9b5bd00fdb104f7f8ff9e31e5486b00f60b71b64"
...
git-tree-sha1 = "c220355bd08a32a9ff6d13312cf1d06a2ffdac17"
...
git-tree-sha1 = "1498d2629c8da6b75de089f40da55863b46416a8"
