...
# ╔═╡ a067f4ba-25da-11ec-0a77-7dd074dc5b29
using Plots
...
anim = @animate for angle in 0:0.05:2pi
	plot_frame(angle)
end
...
anim_fast = @animate for angle in 0:0.05:2pi
	plot_frame(angle)
end every 10
...
# ╔═╡ 026dbc07-c7fb-4ccf-8112-26fbdce9e992


# ╔═╡ d1938c28-9a28-4a57-bc95-364a77c771fd
anim_partial = @animate for angle in 0:0.05:2pi
	plot_frame(angle)
end when 0 <= angle <= pi

# ╔═╡ d181205d-fe00-4e4e-a50e-0ba6aee935db
gif(anim_partial)
